...
export function CurrencyInput({
  ...
  defaultValue = "",
  required = false,
  className = "mt-1.5 h-11 w-full rounded-xl border border-[#dbe5f1] bg-[#f8fbff] px-2.5 text-xs font-bold outline-none focus:border-[#2563eb] focus:bg-white transition-all",
  onValueChange,
  onChange,
}: CurrencyInputProps) {
