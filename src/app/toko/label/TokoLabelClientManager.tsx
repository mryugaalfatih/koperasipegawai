        ...
        <div className="overflow-x-auto rounded-xl border border-[#dbe5f1]">
          <table className="w-full text-left text-xs">
            <thead className="bg-[#f8fbff] text-[#475569] border-b border-[#dbe5f1]">
              <tr>
                <th className="px-4 py-3 font-bold text-center w-12">
                  <input
                    type="checkbox"
                ...
                <th className="px-4 py-3 font-bold">Nama Barang Sembako</th>
                <th className="px-4 py-3 font-bold">Barcode / SKU</th>
                <th className="px-4 py-3 font-bold text-right">Harga Umum</th>
                <th className="px-4 py-3 font-bold text-right text-[#2563eb]">Harga Anggota</th>
              </tr>
            </thead>
              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 font-bold text-[#0b1220]">{product.name}</td>
                    <td className="px-4 py-3 font-mono text-[#64748b]">{product.barcode ?? "-"}</td>
                    <td className="px-4 py-3 font-semibold text-right">{formatRupiah(product.sell_price_general)}</td>
