        ...
        <div className="overflow-x-auto rounded-xl border border-[#dbe5f1]">
          <table className="w-full text-left text-xs">
            <thead className="bg-[#f8fbff] text-[#475569] border-b border-[#dbe5f1]">
              <tr>
                <th className="px-3 py-3 font-bold">Kode / Nama Barang APAR</th>
                <th className="px-3 py-3 font-bold">Kategori</th>
                <th className="px-3 py-3 font-bold text-center">Media & Ukuran</th>
                <th className="px-3 py-3 font-bold text-right">Harga Jual Unit Baru</th>
                <th className="px-3 py-3 font-bold text-right text-[#be123c]">Harga Refill / Kg</th>
                <th className="px-3 py-3 font-bold text-center">Stok</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#e2e8f0]">
              {filteredProducts.map((p) => (
                <tr key={p.id} className="hover:bg-[#f8fbff] transition-colors">
                  ...
                  <td className="px-3 py-3 text-center font-bold text-[#0b1220]">
                    {p.media_type} {p.capacity_kg ? `${p.capacity_kg} Kg` : ""}
                  </td>
                  <td className="px-3 py-3 text-right font-black text-[#0b1220]">
                    {formatRupiah(p.sell_price)}
                  </td>
                  <td className="px-3 py-3 text-right font-black text-[#be123c]">
