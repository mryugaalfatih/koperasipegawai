...
import { createBusinessUnit, toggleBusinessUnitStatus } from "./actions";
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {unitRows.map((unit) => {
                    ...
                    const isTOKO = unit.code === "TOKO";
                    const isJASA = unit.code === "JASA";
                      ...
                      >
                        ...
                        <div className="mt-5 border-t border-[#f1f5f9] pt-4">
                          <form action={toggleBusinessUnitStatus}>
                            ...
                            <button
                              className={`inline-flex h-9 w-full items-center justify-center gap-2 rounded-2xl text-xs font-bold transition-all ${
                                unit.is_active
